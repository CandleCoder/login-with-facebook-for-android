[![Build Status](https://travis-ci.org/CandleCoder/login-with-facebook-for-android.svg?branch=master)](https://travis-ci.org/CandleCoder/login-with-facebook-for-android)
